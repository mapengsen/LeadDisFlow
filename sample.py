...
class SampleScaffolds(ma.Action):
    ...
    def __init__(self, model, batch_size=128, num_randomized_smiles=32, num_decorations_per_scaffold=32,
        ...
        if repeated_randomized_smiles:
            print("Generating repeated randomized smiles.")
            self._generate_func = _generate_randomized_repeated
        else:
            print("Generating not repeated randomized smiles.")
...
def parse_args():
    ...
    parser.add_argument("--batch-size", "-b",
                        help="Batch size (beware GPU memory usage) [DEFAULT: 128]", type=int, default=512)
    ...
    parser.add_argument("--repeated-randomized-smiles", help="The randomized SMILES can be repeated.default is generated no repeated SMILES.",
...
def main():
    ...
    if args.output_format == "parquet":
        ...
        # from utils import csv_filter
        # csv_filter.csv_filter_addCanonical_addScaffold(args.output_path)
